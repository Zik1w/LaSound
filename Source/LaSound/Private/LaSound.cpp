...
#define MODULE_NAME "LaSound"
#define LOCTEXT_NAMESPACE "FLaSoundModule"

void FLaSoundModule::StartupModule()
{
...
void FLaSoundModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FLaSoundModule, LaSound)
