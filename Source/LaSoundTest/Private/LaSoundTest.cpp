...
#define MODULE_NAME "LaSoundTest"
#define LOCTEXT_NAMESPACE "FLaSoundTestModule"

void FLaSoundTestModule::StartupModule()
{
...
void FLaSoundTestModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FLaSoundTestModule, LaSoundTest)
